...
public class MainRunner {
    ...
    public static void myClasses(Student student, List<Course> courseList, List<Attending> attendingList){
        ...
        for(Course course : courses){
            System.out.printf("%-5s|%-25s|%-25s", course.getID(), course.getName(), course.getInstructor());// should be
    ...
    public static void allClasses(List<Course> courseList){
        ...
        for(Course course : courseList){
            System.out.printf("%-5s|%-25s|%-25s", course.getID(), course.getName(), course.getInstructor());// get id??
